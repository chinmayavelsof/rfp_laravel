                 ...
                 <div class="card-body">
                     <form class="validateJs">
                         <div class="row">
                             <div class="col-lg-4 col-md-4">
                                 <div class="form-group">
                                     <label for="VendorPrice">Vendor Price<em>*</em></label>
                                     <input type="number" class="form-control" id="VendorPrice" name="VendorPrice" placeholder="" data-rule-mandatory="true">
                                 </div>
                             </div>
                         </div>
                         <div class="row">
                         ...
                         <div class="row">
                             ...
                             <div class="col-lg-6 col-md-6">
                                 <div class="form-group">
                                     <label for="total">Total Cost<em>*</em></label>
                                     <input type="number" class="form-control" id="total" name="total" placeholder="" data-rule-mandatory="true">
                                 </div>
                             </div>
                         </div>
